...
void SPI1_Initialize(void) {
    ...
    // R_nW write_noTX; P stopbit_notdetected; S startbit_notdetected; BF RCinprocess_TXcomplete; SMP Sample At End; UA dontupdate; CKE Active to Idle; D_nA lastbyte_address; 
    SSP1STAT = 0xC0;
